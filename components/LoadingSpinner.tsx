...
export const LogoSpinner: React.FC = () => (
  <div className="relative w-12 h-12">
    <div className="absolute top-0 left-0 w-full h-full border-2 border-slate-100 rounded-full"></div>
...
export const SkeletonCard: React.FC = () => (
  <div className="flex flex-col animate-pulse">
    <div className="game-cover-ratio bg-slate-200 rounded-2xl border border-slate-100"></div>
